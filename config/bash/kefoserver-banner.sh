# root@kefoserver — terminal banner + prompt.
# Installed to /etc/kefoserver-banner.sh and sourced from ~/.bashrc by
...
PS1='\[\e[1;32m\]root@kefoserver\[\e[0m\]:\[\e[1;34m\]\w\[\e[0m\]\$ '

cat <<'BANNER'

  ╭──────────────────────────────────────────────────────────────╮
  │  root@kefoserver · fxmq.net kefoserver · Debian 13             │
  ╰──────────────────────────────────────────────────────────────╯
