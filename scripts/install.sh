...
# NC recovery manifests live OUTSIDE the repo (homelab/cloud/recovery/ —
# instance state generated by `make nc-capture`; never committed). Handles
# both REPO spellings (…/homelab or …/homelab/repo).
MANIFEST_DIR="${REPO%/repo}/cloud/recovery"
...
nextcloud_setup() {
  ...
  # Recovery manifest: users + quotas (homelab/cloud/recovery/users.txt, kept
